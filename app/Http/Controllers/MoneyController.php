  ...
  /**
    ...
    public function customerMpesaSTKPush()
    {
        ...
        $curl_post_data = [
            ...
            'AccountReference' => "Evans Mwangangi",
    ...
    {
        $consumer_key="V72Uf93McGiw4TwOlIeEavJQ3PTUef4e";//enter safaricom customer  keys
        $consumer_secret="91hIt8Xi3IAEbcJQ";//enter safaricom secret keys
